...
from safety_brax.components.spectral_norm import SNDense
...
def make_activation_fn(activation_name: str) -> ActivationFn:
    ...
    str2activation = {
        ...
        "gelu": linen.gelu,
        "glu": linen.glu,
        "hard_sigmoid": linen.hard_sigmoid,
        "hard_silu": linen.hard_silu,
        "hard_swish": linen.hard_swish,
        "hard_tanh": linen.hard_tanh,
        "leaky_relu": linen.leaky_relu,
        "log_sigmoid": linen.log_sigmoid,
        "log_softmax": linen.log_softmax,
        "logsumexp": linen.logsumexp,
        "normalize": linen.normalize,
        "one_hot": linen.one_hot,
        "relu": linen.relu,
        "relu6": linen.relu6,
        "selu": linen.selu,
        "silu": linen.silu,
        "soft_sign": linen.soft_sign,
        "softmax": linen.softmax,
        "softplus": linen.softplus,
        "swish": linen.swish,
        "tanh": linen.tanh,
    }
    assert activation_name in str2activation, f"Unknown activation: {activation_name}"
    return str2activation[activation_name]
